	...
	public static abstract class TripEntry implements BaseColumns {
		...
		public static final String CREATE_SQL =
				"CREATE TABLE " + TABLE_NAME + " (" +
						...
						COLUMN_UPDATED_AT + DatabaseConstants.SQLITE_TIMESTAMP_TYPE + DatabaseConstants.COMMA_SEP +
						"FOREIGN KEY(" + COLUMN_ID_STATUS + ") REFERENCES " + StatusEntry.TABLE_NAME + "(" + StatusEntry.COLUMN_ID_STATUS + ")" + DatabaseConstants.COMMA_SEP +
	...
	public static abstract class RecordEntry implements BaseColumns {
		...
		public static final String CREATE_SQL =
				"CREATE TABLE " + TABLE_NAME + " (" +
						...
						COLUMN_CREATED_AT + DatabaseConstants.SQLITE_TIMESTAMP_TYPE + DatabaseConstants.COMMA_SEP +
						COLUMN_UPDATED_AT + DatabaseConstants.SQLITE_TIMESTAMP_TYPE + DatabaseConstants.COMMA_SEP +
						"FOREIGN KEY(" + COLUMN_ID_RECORD_TYPE + ") REFERENCES " + RecordTypeEntry.TABLE_NAME + "(" + RecordTypeEntry.COLUMN_ID_RECORD_TYPE + ")" + DatabaseConstants.COMMA_SEP +
						"FOREIGN KEY(" + COLUMN_ID_TRIP + ") REFERENCES " + TripEntry.TABLE_NAME + "(" + TripEntry.COLUMN_ID_TRIP + ")" + DatabaseConstants.COMMA_SEP +
